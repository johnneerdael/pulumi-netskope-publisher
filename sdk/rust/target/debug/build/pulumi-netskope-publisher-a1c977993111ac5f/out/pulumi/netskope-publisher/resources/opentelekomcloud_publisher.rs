...
pub mod opentelekomcloud_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct OpentelekomcloudPublisherArgs {
        ...
        #[builder(into, default)]
        pub flavor_id: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
        pub flavor_name: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
    ...
    #[allow(dead_code)]
    pub struct OpentelekomcloudPublisherResult {
        ...
        pub flavor_id: pulumi_gestalt_rust::Output<Option<String>>,
        pub flavor_name: pulumi_gestalt_rust::Output<Option<String>>,
        pub guest_network_interface: pulumi_gestalt_rust::Output<
            Option<super::types::provider::GuestNetworkInterface>,
        >,
        pub image_id: pulumi_gestalt_rust::Output<Option<String>>,
        pub image_name: pulumi_gestalt_rust::Output<Option<String>>,
    ...
    ) -> OpentelekomcloudPublisherResult {
    ...
    fn __create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:OpentelekomcloudPublisher".into(),
            name: name.to_string(),
