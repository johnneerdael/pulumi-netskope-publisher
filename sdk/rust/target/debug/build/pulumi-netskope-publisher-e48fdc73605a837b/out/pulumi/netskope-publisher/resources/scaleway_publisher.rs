...
pub mod scaleway_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct ScalewayPublisherArgs {
        ...
        #[builder(into, default)]
        pub enable_dynamic_ip: pulumi_gestalt_rust::Input<Option<bool>>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub security_group_id: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
    ...
    #[allow(dead_code)]
    pub struct ScalewayPublisherResult {
        ...
        pub enable_dynamic_ip: pulumi_gestalt_rust::Output<Option<bool>>,
        ...
        pub security_group_id: pulumi_gestalt_rust::Output<Option<String>>,
    ...
    fn __create(
        ...
        let enable_dynamic_ip_binding = args.enable_dynamic_ip.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:ScalewayPublisher".into(),
            name: name.to_string(),
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "enableDynamicIp".into(),
                    value: &enable_dynamic_ip_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        ScalewayPublisherResult {
            ...
            enable_dynamic_ip: o.get_field("enableDynamicIp"),
