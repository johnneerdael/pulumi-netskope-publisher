...
pub mod alicloud_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct AlicloudPublisherArgs {
        #[builder(into, default)]
        pub allocate_public_ip: pulumi_gestalt_rust::Input<Option<bool>>,
        #[builder(into, default)]
        ...
        #[builder(into)]
        pub vswitch_id: pulumi_gestalt_rust::Input<String>,
        #[builder(into, default)]
        pub wizard_path: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
    pub struct AlicloudPublisherResult {
        /// Pulumi ID is the provider-assigned unique ID for this managed resource.
        /// It is set during deployments and may be missing (unknown) during planning phases.
        pub id: pulumi_gestalt_rust::Output<String>,
        /// Pulumi URN is the stable logical identity of this resource in the Pulumi stack.
        pub urn: pulumi_gestalt_rust::Output<String>,
        pub allocate_public_ip: pulumi_gestalt_rust::Output<Option<bool>>,
        ...
        pub vswitch_id: pulumi_gestalt_rust::Output<String>,
    ...
    fn __create(
        ...
        let allocate_public_ip_binding = args.allocate_public_ip.get_output(ctx);
        ...
        let vswitch_id_binding = args.vswitch_id.get_output(ctx);
        let wizard_path_binding = args.wizard_path.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:AlicloudPublisher".into(),
            name: name.to_string(),
            version: super::get_version(),
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "allocatePublicIp".into(),
                    value: &allocate_public_ip_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "apiToken".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "vswitchId".into(),
                    value: &vswitch_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        AlicloudPublisherResult {
            id: o.get_id(),
            urn: o.get_urn(),
            allocate_public_ip: o.get_field("allocatePublicIp"),
            ...
            vswitch_id: o.get_field("vswitchId"),
