...
pub mod tencentcloud_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct TencentcloudPublisherArgs {
        ...
        #[builder(into, default)]
        pub system_disk_size: pulumi_gestalt_rust::Input<Option<i32>>,
        #[builder(into, default)]
        pub system_disk_type: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
    ...
    #[allow(dead_code)]
    pub struct TencentcloudPublisherResult {
        ...
        pub system_disk_size: pulumi_gestalt_rust::Output<Option<i32>>,
        pub system_disk_type: pulumi_gestalt_rust::Output<Option<String>>,
    ...
    pub fn create(
        ...
        name: &str,
        args: TencentcloudPublisherArgs,
    ) -> TencentcloudPublisherResult {
    ...
    fn __create(
        ...
        let system_disk_size_binding = args.system_disk_size.get_output(ctx);
        let system_disk_type_binding = args.system_disk_type.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:TencentcloudPublisher".into(),
            name: name.to_string(),
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "systemDiskSize".into(),
                    value: &system_disk_size_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "systemDiskType".into(),
                    value: &system_disk_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
        ...
        TencentcloudPublisherResult {
            ...
            system_disk_size: o.get_field("systemDiskSize"),
            system_disk_type: o.get_field("systemDiskType"),
