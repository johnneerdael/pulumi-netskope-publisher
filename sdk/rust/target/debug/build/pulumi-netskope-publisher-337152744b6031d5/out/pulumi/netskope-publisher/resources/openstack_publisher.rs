...
pub mod openstack_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct OpenstackPublisherArgs {
        #[builder(into, default)]
        pub api_token: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
        pub assign_floating_ip: pulumi_gestalt_rust::Input<Option<bool>>,
        #[builder(into, default)]
        ...
        #[builder(into)]
        pub flavor_name: pulumi_gestalt_rust::Input<String>,
        #[builder(into, default)]
        pub floating_ip_pool: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
    ...
    #[allow(dead_code)]
    pub struct OpenstackPublisherResult {
        ...
        pub assign_floating_ip: pulumi_gestalt_rust::Output<Option<bool>>,
        ...
        pub flavor_name: pulumi_gestalt_rust::Output<String>,
        pub floating_ip_pool: pulumi_gestalt_rust::Output<Option<String>>,
    ...
    pub fn create(
        ...
        name: &str,
        args: OpenstackPublisherArgs,
    ) -> OpenstackPublisherResult {
    ...
    fn __create(
        ...
        let assign_floating_ip_binding = args.assign_floating_ip.get_output(ctx);
        ...
        let flavor_name_binding = args.flavor_name.get_output(ctx);
        let floating_ip_pool_binding = args.floating_ip_pool.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:OpenstackPublisher".into(),
            name: name.to_string(),
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "assignFloatingIp".into(),
                    value: &assign_floating_ip_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "authMode".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "flavorName".into(),
                    value: &flavor_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "floatingIpPool".into(),
                    value: &floating_ip_pool_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "keyPair".into(),
                    value: &key_pair_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        OpenstackPublisherResult {
            ...
            assign_floating_ip: o.get_field("assignFloatingIp"),
            ...
            flavor_name: o.get_field("flavorName"),
            floating_ip_pool: o.get_field("floatingIpPool"),
