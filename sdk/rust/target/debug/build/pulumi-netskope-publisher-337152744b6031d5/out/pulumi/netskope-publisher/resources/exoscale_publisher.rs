...
pub mod exoscale_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct ExoscalePublisherArgs {
        ...
        #[builder(into)]
        pub disk_size: pulumi_gestalt_rust::Input<i32>,
        #[builder(into, default)]
    ...
    #[allow(dead_code)]
    pub struct ExoscalePublisherResult {
    ...
    pub fn create(
        ...
        name: &str,
        args: ExoscalePublisherArgs,
    ) -> ExoscalePublisherResult {
    ...
    fn __create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:ExoscalePublisher".into(),
            name: name.to_string(),
