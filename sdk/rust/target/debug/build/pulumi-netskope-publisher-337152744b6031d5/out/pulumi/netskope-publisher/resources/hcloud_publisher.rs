...
pub mod hcloud_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct HcloudPublisherArgs {
        ...
        #[builder(into, default)]
        pub datacenter: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
        pub delete_default_user: pulumi_gestalt_rust::Input<Option<bool>>,
        #[builder(into, default)]
        pub firewall_ids: pulumi_gestalt_rust::Input<Option<Vec<i32>>>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub network_id: pulumi_gestalt_rust::Input<Option<i32>>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub server_type: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
    ...
    #[allow(dead_code)]
    pub struct HcloudPublisherResult {
        ...
        pub datacenter: pulumi_gestalt_rust::Output<Option<String>>,
        pub delete_default_user: pulumi_gestalt_rust::Output<Option<bool>>,
        pub firewall_ids: pulumi_gestalt_rust::Output<Option<Vec<i32>>>,
        ...
        pub network_id: pulumi_gestalt_rust::Output<Option<i32>>,
        ...
        pub server_type: pulumi_gestalt_rust::Output<Option<String>>,
    ...
    fn __create(
        ...
        let firewall_ids_binding = args.firewall_ids.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:HcloudPublisher".into(),
            name: name.to_string(),
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &firewall_ids_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
