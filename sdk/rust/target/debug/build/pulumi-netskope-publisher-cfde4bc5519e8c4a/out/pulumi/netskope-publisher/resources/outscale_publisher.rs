...
pub mod outscale_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct OutscalePublisherArgs {
        ...
        >,
        #[builder(into, default)]
        pub keypair_name: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub placement_subregion_name: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub vm_type: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
        pub wizard_path: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
    pub struct OutscalePublisherResult {
        ...
        pub install_user_ssh_authorized_keys: pulumi_gestalt_rust::Output<
            Option<Vec<String>>,
        >,
        pub keypair_name: pulumi_gestalt_rust::Output<Option<String>>,
        ...
        pub placement_subregion_name: pulumi_gestalt_rust::Output<Option<String>>,
        ...
        pub vm_type: pulumi_gestalt_rust::Output<Option<String>>,
    ...
    pub fn create(
        ...
        name: &str,
        args: OutscalePublisherArgs,
    ) -> OutscalePublisherResult {
    ...
    fn __create(
        ...
        let install_user_ssh_authorized_keys_binding = args
            ...
            .get_output(ctx);
        let keypair_name_binding = args.keypair_name.get_output(ctx);
        ...
        let placement_subregion_name_binding = args
        ...
        let vm_type_binding = args.vm_type.get_output(ctx);
        let wizard_path_binding = args.wizard_path.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:OutscalePublisher".into(),
            name: name.to_string(),
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &keypair_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "placementSubregionName".into(),
                    value: &placement_subregion_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "vmType".into(),
                    value: &vm_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        OutscalePublisherResult {
            ...
            keypair_name: o.get_field("keypairName"),
            ...
            placement_subregion_name: o.get_field("placementSubregionName"),
