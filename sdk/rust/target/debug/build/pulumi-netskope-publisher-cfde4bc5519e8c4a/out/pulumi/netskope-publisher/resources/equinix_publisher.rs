...
pub mod equinix_publisher {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct EquinixPublisherArgs {
        ...
        #[builder(into, default)]
        pub billing_cycle: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
        ...
        >,
        #[builder(into)]
        pub metro: pulumi_gestalt_rust::Input<String>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub project_ssh_key_ids: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub user_ssh_key_ids: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        #[builder(into, default)]
        pub wizard_path: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
    pub struct EquinixPublisherResult {
        ...
        pub billing_cycle: pulumi_gestalt_rust::Output<Option<String>>,
        ...
        pub install_user_ssh_authorized_keys: pulumi_gestalt_rust::Output<
            Option<Vec<String>>,
        >,
        pub metro: pulumi_gestalt_rust::Output<String>,
        ...
        pub project_ssh_key_ids: pulumi_gestalt_rust::Output<Option<Vec<String>>>,
        ...
        pub user_ssh_key_ids: pulumi_gestalt_rust::Output<Option<Vec<String>>>,
    ...
    pub fn create(
        ...
        name: &str,
        args: EquinixPublisherArgs,
    ) -> EquinixPublisherResult {
    ...
    fn __create(
        ...
        let billing_cycle_binding = args.billing_cycle.get_output(ctx);
        ...
        let install_user_ssh_authorized_keys_binding = args
            ...
            .get_output(ctx);
        let metro_binding = args.metro.get_output(ctx);
        ...
        let project_ssh_key_ids_binding = args.project_ssh_key_ids.get_output(ctx);
        ...
        let user_ssh_key_ids_binding = args.user_ssh_key_ids.get_output(ctx);
        let wizard_path_binding = args.wizard_path.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "netskope-publisher:index:EquinixPublisher".into(),
            name: name.to_string(),
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "billingCycle".into(),
                    value: &billing_cycle_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "bootstrap".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "projectSshKeyIds".into(),
                    value: &project_ssh_key_ids_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "userSshKeyIds".into(),
                    value: &user_ssh_key_ids_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        EquinixPublisherResult {
            ...
            billing_cycle: o.get_field("billingCycle"),
            ...
            project_ssh_key_ids: o.get_field("projectSshKeyIds"),
            ...
            user_ssh_key_ids: o.get_field("userSshKeyIds"),
