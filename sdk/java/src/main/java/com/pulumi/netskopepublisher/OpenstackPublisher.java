...
import com.pulumi.netskopepublisher.OpenstackPublisherArgs;
...
@ResourceType(type="netskope-publisher:index:OpenstackPublisher")
public class OpenstackPublisher extends com.pulumi.resources.ComponentResource {
    ...
    @Export(name="assignFloatingIp", refs={Boolean.class}, tree="[0]")
    private Output</* @Nullable */ Boolean> assignFloatingIp;

    public Output<Optional<Boolean>> assignFloatingIp() {
        return Codegen.optional(this.assignFloatingIp);
    }
    ...
    @Export(name="floatingIpPool", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> floatingIpPool;

    public Output<Optional<String>> floatingIpPool() {
        return Codegen.optional(this.floatingIpPool);
    }
     ...
     */
    public OpenstackPublisher(java.lang.String name) {
        this(name, OpenstackPublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public OpenstackPublisher(java.lang.String name, OpenstackPublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OpenstackPublisher(java.lang.String name, OpenstackPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:OpenstackPublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static OpenstackPublisherArgs makeArgs(OpenstackPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OpenstackPublisherArgs.Empty : args;
    }
