...
public class GcpPublisher extends com.pulumi.resources.ComponentResource {
     ...
     */
    public GcpPublisher(java.lang.String name) {
        this(name, GcpPublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GcpPublisher(java.lang.String name, GcpPublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GcpPublisher(java.lang.String name, GcpPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:GcpPublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static GcpPublisherArgs makeArgs(GcpPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GcpPublisherArgs.Empty : args;
    }
