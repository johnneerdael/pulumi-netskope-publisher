...
import com.pulumi.netskopepublisher.OvhPublisherArgs;
...
@ResourceType(type="netskope-publisher:index:OvhPublisher")
public class OvhPublisher extends com.pulumi.resources.ComponentResource {
     ...
     */
    public OvhPublisher(java.lang.String name) {
        this(name, OvhPublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public OvhPublisher(java.lang.String name, OvhPublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OvhPublisher(java.lang.String name, OvhPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:OvhPublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static OvhPublisherArgs makeArgs(OvhPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OvhPublisherArgs.Empty : args;
    }
