...
import com.pulumi.netskopepublisher.EquinixPublisherArgs;
...
@ResourceType(type="netskope-publisher:index:EquinixPublisher")
public class EquinixPublisher extends com.pulumi.resources.ComponentResource {
     ...
     */
    public EquinixPublisher(java.lang.String name) {
        this(name, EquinixPublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public EquinixPublisher(java.lang.String name, EquinixPublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EquinixPublisher(java.lang.String name, EquinixPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:EquinixPublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static EquinixPublisherArgs makeArgs(EquinixPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? EquinixPublisherArgs.Empty : args;
    }
