...
import com.pulumi.netskopepublisher.ExoscalePublisherArgs;
...
@ResourceType(type="netskope-publisher:index:ExoscalePublisher")
public class ExoscalePublisher extends com.pulumi.resources.ComponentResource {
     ...
     */
    public ExoscalePublisher(java.lang.String name) {
        this(name, ExoscalePublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ExoscalePublisher(java.lang.String name, ExoscalePublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ExoscalePublisher(java.lang.String name, ExoscalePublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:ExoscalePublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static ExoscalePublisherArgs makeArgs(ExoscalePublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ExoscalePublisherArgs.Empty : args;
    }
