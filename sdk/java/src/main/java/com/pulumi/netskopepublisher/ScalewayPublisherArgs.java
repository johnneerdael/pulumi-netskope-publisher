...
public final class ScalewayPublisherArgs extends com.pulumi.resources.ResourceArgs {

    public static final ScalewayPublisherArgs Empty = new ScalewayPublisherArgs();
    ...
    private @Nullable Boolean enableDynamicIp;

    public Optional<Boolean> enableDynamicIp() {
    ...
    public static Builder builder(ScalewayPublisherArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ScalewayPublisherArgs();
        }

        public Builder(ScalewayPublisherArgs defaults) {
            $ = new ScalewayPublisherArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder enableDynamicIp(@Nullable Boolean enableDynamicIp) {
        ...
        public ScalewayPublisherArgs build() {
            return $;
        }
    }
