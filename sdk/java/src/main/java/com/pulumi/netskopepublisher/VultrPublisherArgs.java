...
public final class VultrPublisherArgs extends com.pulumi.resources.ResourceArgs {

    public static final VultrPublisherArgs Empty = new VultrPublisherArgs();
    ...
    private @Nullable String firewallGroupId;

    public Optional<String> firewallGroupId() {
    ...
    @Import(name="osId")
    private @Nullable Integer osId;

    public Optional<Integer> osId() {
    ...
    private VultrPublisherArgs() {}

    private VultrPublisherArgs(VultrPublisherArgs $) {
    ...
    public static Builder builder(VultrPublisherArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VultrPublisherArgs();
        }

        public Builder(VultrPublisherArgs defaults) {
            $ = new VultrPublisherArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder firewallGroupId(@Nullable String firewallGroupId) {
        ...
        public VultrPublisherArgs build() {
            if ($.plan == null) {
                throw new MissingRequiredPropertyException("VultrPublisherArgs", "plan");
            }
            if ($.region == null) {
                throw new MissingRequiredPropertyException("VultrPublisherArgs", "region");
            }
            return $;
        }
    }
