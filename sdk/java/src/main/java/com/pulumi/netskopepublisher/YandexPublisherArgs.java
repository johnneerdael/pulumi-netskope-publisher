...
public final class YandexPublisherArgs extends com.pulumi.resources.ResourceArgs {

    public static final YandexPublisherArgs Empty = new YandexPublisherArgs();
    ...
    @Import(name="coreFraction")
    private @Nullable Integer coreFraction;

    public Optional<Integer> coreFraction() {
        return Optional.ofNullable(this.coreFraction);
    }
    ...
    private YandexPublisherArgs() {}

    private YandexPublisherArgs(YandexPublisherArgs $) {
    ...
    public static Builder builder(YandexPublisherArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new YandexPublisherArgs();
        }

        public Builder(YandexPublisherArgs defaults) {
            $ = new YandexPublisherArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder coreFraction(@Nullable Integer coreFraction) {
        ...
        public YandexPublisherArgs build() {
            if ($.imageId == null) {
                throw new MissingRequiredPropertyException("YandexPublisherArgs", "imageId");
            }
            if ($.subnetId == null) {
                throw new MissingRequiredPropertyException("YandexPublisherArgs", "subnetId");
            }
            return $;
        }
    }
