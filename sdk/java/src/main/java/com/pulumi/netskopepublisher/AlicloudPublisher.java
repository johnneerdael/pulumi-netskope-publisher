...
import com.pulumi.netskopepublisher.AlicloudPublisherArgs;
...
@ResourceType(type="netskope-publisher:index:AlicloudPublisher")
public class AlicloudPublisher extends com.pulumi.resources.ComponentResource {
     ...
     */
    public AlicloudPublisher(java.lang.String name) {
        this(name, AlicloudPublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AlicloudPublisher(java.lang.String name, AlicloudPublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AlicloudPublisher(java.lang.String name, AlicloudPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:AlicloudPublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static AlicloudPublisherArgs makeArgs(AlicloudPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AlicloudPublisherArgs.Empty : args;
    }
