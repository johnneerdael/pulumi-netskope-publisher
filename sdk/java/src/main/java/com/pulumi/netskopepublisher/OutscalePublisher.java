...
import com.pulumi.netskopepublisher.OutscalePublisherArgs;
...
@ResourceType(type="netskope-publisher:index:OutscalePublisher")
public class OutscalePublisher extends com.pulumi.resources.ComponentResource {
    ...
    private Output</* @Nullable */ String> placementSubregionName;

    public Output<Optional<String>> placementSubregionName() {
        return Codegen.optional(this.placementSubregionName);
    }
    ...
    private Output</* @Nullable */ String> vmType;

    public Output<Optional<String>> vmType() {
        return Codegen.optional(this.vmType);
    }
     ...
     */
    public OutscalePublisher(java.lang.String name) {
        this(name, OutscalePublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public OutscalePublisher(java.lang.String name, OutscalePublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OutscalePublisher(java.lang.String name, OutscalePublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:OutscalePublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static OutscalePublisherArgs makeArgs(OutscalePublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OutscalePublisherArgs.Empty : args;
    }
