...
import com.pulumi.netskopepublisher.ProviderArgs;
import com.pulumi.netskopepublisher.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:netskope-publisher")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("netskope-publisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
