...
import com.pulumi.netskopepublisher.YandexPublisherArgs;
...
@ResourceType(type="netskope-publisher:index:YandexPublisher")
public class YandexPublisher extends com.pulumi.resources.ComponentResource {
    ...
    @Export(name="coreFraction", refs={Integer.class}, tree="[0]")
    private Output</* @Nullable */ Integer> coreFraction;

    public Output<Optional<Integer>> coreFraction() {
        return Codegen.optional(this.coreFraction);
    }
     ...
     */
    public YandexPublisher(java.lang.String name) {
        this(name, YandexPublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public YandexPublisher(java.lang.String name, YandexPublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public YandexPublisher(java.lang.String name, YandexPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:YandexPublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static YandexPublisherArgs makeArgs(YandexPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? YandexPublisherArgs.Empty : args;
    }
