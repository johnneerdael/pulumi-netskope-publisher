...
import com.pulumi.netskopepublisher.NutanixPublisherArgs;
...
@ResourceType(type="netskope-publisher:index:NutanixPublisher")
public class NutanixPublisher extends com.pulumi.resources.ComponentResource {
    ...
    @Export(name="imageUuid", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> imageUuid;

    public Output<Optional<String>> imageUuid() {
        return Codegen.optional(this.imageUuid);
    }
    ...
    @Export(name="memorySizeMib", refs={Integer.class}, tree="[0]")
    private Output</* @Nullable */ Integer> memorySizeMib;

    public Output<Optional<Integer>> memorySizeMib() {
        return Codegen.optional(this.memorySizeMib);
    }
    ...
    @Export(name="numCoresPerVcpu", refs={Integer.class}, tree="[0]")
    private Output</* @Nullable */ Integer> numCoresPerVcpu;

    public Output<Optional<Integer>> numCoresPerVcpu() {
        return Codegen.optional(this.numCoresPerVcpu);
    }
    ...
    private Output</* @Nullable */ String> subnetUuid;

    public Output<Optional<String>> subnetUuid() {
        return Codegen.optional(this.subnetUuid);
    }
     ...
     */
    public NutanixPublisher(java.lang.String name) {
        this(name, NutanixPublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public NutanixPublisher(java.lang.String name, NutanixPublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NutanixPublisher(java.lang.String name, NutanixPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:NutanixPublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static NutanixPublisherArgs makeArgs(NutanixPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? NutanixPublisherArgs.Empty : args;
    }
