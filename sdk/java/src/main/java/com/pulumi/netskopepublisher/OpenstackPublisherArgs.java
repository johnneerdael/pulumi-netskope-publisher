...
public final class OpenstackPublisherArgs extends com.pulumi.resources.ResourceArgs {

    public static final OpenstackPublisherArgs Empty = new OpenstackPublisherArgs();
    ...
    @Import(name="assignFloatingIp")
    private @Nullable Boolean assignFloatingIp;

    public Optional<Boolean> assignFloatingIp() {
    ...
    private OpenstackPublisherArgs() {}
    ...
    public static Builder builder(OpenstackPublisherArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OpenstackPublisherArgs();
        }

        public Builder(OpenstackPublisherArgs defaults) {
            $ = new OpenstackPublisherArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder assignFloatingIp(@Nullable Boolean assignFloatingIp) {
        ...
        public OpenstackPublisherArgs build() {
            if ($.flavorName == null) {
                throw new MissingRequiredPropertyException("OpenstackPublisherArgs", "flavorName");
            }
            if ($.imageName == null) {
                throw new MissingRequiredPropertyException("OpenstackPublisherArgs", "imageName");
            }
            if ($.networkName == null) {
                throw new MissingRequiredPropertyException("OpenstackPublisherArgs", "networkName");
            }
            return $;
        }
    }
