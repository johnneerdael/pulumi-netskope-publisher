...
import com.pulumi.netskopepublisher.DigitaloceanPublisherArgs;
...
@ResourceType(type="netskope-publisher:index:DigitaloceanPublisher")
public class DigitaloceanPublisher extends com.pulumi.resources.ComponentResource {
     ...
     */
    public DigitaloceanPublisher(java.lang.String name) {
        this(name, DigitaloceanPublisherArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DigitaloceanPublisher(java.lang.String name, DigitaloceanPublisherArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DigitaloceanPublisher(java.lang.String name, DigitaloceanPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("netskope-publisher:index:DigitaloceanPublisher", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true);
    }

    private static DigitaloceanPublisherArgs makeArgs(DigitaloceanPublisherArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DigitaloceanPublisherArgs.Empty : args;
    }
