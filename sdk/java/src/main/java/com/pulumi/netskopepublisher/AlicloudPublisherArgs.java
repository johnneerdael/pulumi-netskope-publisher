...
public final class AlicloudPublisherArgs extends com.pulumi.resources.ResourceArgs {

    public static final AlicloudPublisherArgs Empty = new AlicloudPublisherArgs();

    @Import(name="allocatePublicIp")
    private @Nullable Boolean allocatePublicIp;

    public Optional<Boolean> allocatePublicIp() {
    ...
    private AlicloudPublisherArgs() {}

    private AlicloudPublisherArgs(AlicloudPublisherArgs $) {
    ...
    public static Builder builder(AlicloudPublisherArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlicloudPublisherArgs();
        }

        public Builder(AlicloudPublisherArgs defaults) {
            $ = new AlicloudPublisherArgs(Objects.requireNonNull(defaults));
        }

        public Builder allocatePublicIp(@Nullable Boolean allocatePublicIp) {
        ...
        public AlicloudPublisherArgs build() {
            if ($.imageId == null) {
                throw new MissingRequiredPropertyException("AlicloudPublisherArgs", "imageId");
            }
            if ($.securityGroupIds == null) {
                throw new MissingRequiredPropertyException("AlicloudPublisherArgs", "securityGroupIds");
            }
            if ($.vswitchId == null) {
                throw new MissingRequiredPropertyException("AlicloudPublisherArgs", "vswitchId");
            }
            return $;
        }
    }
