...
{
    [NetskopePublisherResourceType("netskope-publisher:index:OutscalePublisher")]
    public partial class OutscalePublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        ...
        /// <summary>
        /// Create a OutscalePublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public OutscalePublisher(string name, OutscalePublisherArgs args, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:OutscalePublisher", name, args ?? new OutscalePublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class OutscalePublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        public string? PlacementSubregionName { get; set; }
        ...
        public OutscalePublisherArgs()
        {
        }
        public static new OutscalePublisherArgs Empty => new OutscalePublisherArgs();
    }
}
