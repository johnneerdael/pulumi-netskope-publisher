...
{
    [NetskopePublisherResourceType("netskope-publisher:index:OciPublisher")]
    public partial class OciPublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        ...
        /// <summary>
        /// Create a OciPublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public OciPublisher(string name, OciPublisherArgs args, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:OciPublisher", name, args ?? new OciPublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class OciPublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        public OciPublisherArgs()
        {
        }
        public static new OciPublisherArgs Empty => new OciPublisherArgs();
    }
}
