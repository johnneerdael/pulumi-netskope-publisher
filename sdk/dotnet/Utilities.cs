...
namespace Pulumi.NetskopePublisher
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/johnneerdael/pulumi-netskope-publisher";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.NetskopePublisher.version.txt");
    ...
    internal sealed class NetskopePublisherResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NetskopePublisherResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
