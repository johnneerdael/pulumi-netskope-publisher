...
{
    [NetskopePublisherResourceType("netskope-publisher:index:OvhPublisher")]
    public partial class OvhPublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        ...
        /// <summary>
        /// Create a OvhPublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public OvhPublisher(string name, OvhPublisherArgs args, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:OvhPublisher", name, args ?? new OvhPublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class OvhPublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        public OvhPublisherArgs()
        {
        }
        public static new OvhPublisherArgs Empty => new OvhPublisherArgs();
    }
}
