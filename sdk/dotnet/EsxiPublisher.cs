...
{
    [NetskopePublisherResourceType("netskope-publisher:index:EsxiPublisher")]
    public partial class EsxiPublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        ...
        /// <summary>
        /// Create a EsxiPublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public EsxiPublisher(string name, EsxiPublisherArgs args, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:EsxiPublisher", name, args ?? new EsxiPublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class EsxiPublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        public string VirtualNetwork { get; set; } = null!;

        [Input("wizardPath")]
        public string? WizardPath { get; set; }

        public EsxiPublisherArgs()
        {
        }
        public static new EsxiPublisherArgs Empty => new EsxiPublisherArgs();
    }
}
