...
{
    [NetskopePublisherResourceType("netskope-publisher:index:UpcloudPublisher")]
    public partial class UpcloudPublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        ...
        /// <summary>
        /// Create a UpcloudPublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public UpcloudPublisher(string name, UpcloudPublisherArgs args, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:UpcloudPublisher", name, args ?? new UpcloudPublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class UpcloudPublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        public UpcloudPublisherArgs()
        {
        }
        public static new UpcloudPublisherArgs Empty => new UpcloudPublisherArgs();
    }
}
