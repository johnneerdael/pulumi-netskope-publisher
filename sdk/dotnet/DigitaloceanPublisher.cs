...
{
    [NetskopePublisherResourceType("netskope-publisher:index:DigitaloceanPublisher")]
    public partial class DigitaloceanPublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        ...
        /// <summary>
        /// Create a DigitaloceanPublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public DigitaloceanPublisher(string name, DigitaloceanPublisherArgs args, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:DigitaloceanPublisher", name, args ?? new DigitaloceanPublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class DigitaloceanPublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        public DigitaloceanPublisherArgs()
        {
        }
        public static new DigitaloceanPublisherArgs Empty => new DigitaloceanPublisherArgs();
    }
}
