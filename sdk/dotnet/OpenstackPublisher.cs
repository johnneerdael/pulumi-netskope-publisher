...
{
    [NetskopePublisherResourceType("netskope-publisher:index:OpenstackPublisher")]
    public partial class OpenstackPublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        public Output<string?> ApiToken { get; private set; } = null!;

        [Output("assignFloatingIp")]
        public Output<bool?> AssignFloatingIp { get; private set; } = null!;
        ...
        [Output("floatingIpPool")]
        public Output<string?> FloatingIpPool { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a OpenstackPublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public OpenstackPublisher(string name, OpenstackPublisherArgs args, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:OpenstackPublisher", name, args ?? new OpenstackPublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class OpenstackPublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        [Input("assignFloatingIp")]
        public bool? AssignFloatingIp { get; set; }
        ...
        public string? FloatingIpPool { get; set; }
        ...
        public OpenstackPublisherArgs()
        {
        }
        public static new OpenstackPublisherArgs Empty => new OpenstackPublisherArgs();
    }
}
