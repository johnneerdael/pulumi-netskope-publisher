...
{
    [NetskopePublisherResourceType("netskope-publisher:index:OpentelekomcloudPublisher")]
    public partial class OpentelekomcloudPublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        ...
        [Output("networks")]
        public Output<ImmutableArray<ImmutableDictionary<string, object>>> Networks { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a OpentelekomcloudPublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public OpentelekomcloudPublisher(string name, OpentelekomcloudPublisherArgs args, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:OpentelekomcloudPublisher", name, args ?? new OpentelekomcloudPublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class OpentelekomcloudPublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        private InputList<ImmutableDictionary<string, object>>? _networks;
        public InputList<ImmutableDictionary<string, object>> Networks
        {
            get => _networks ?? (_networks = new InputList<ImmutableDictionary<string, object>>());
            set => _networks = value;
        }
        ...
        public OpentelekomcloudPublisherArgs()
        {
        }
        public static new OpentelekomcloudPublisherArgs Empty => new OpentelekomcloudPublisherArgs();
    }
}
