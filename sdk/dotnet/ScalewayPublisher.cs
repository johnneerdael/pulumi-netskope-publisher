...
{
    [NetskopePublisherResourceType("netskope-publisher:index:ScalewayPublisher")]
    public partial class ScalewayPublisher : global::Pulumi.ComponentResource
    {
        [Output("apiToken")]
        ...
        /// <summary>
        /// Create a ScalewayPublisher resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public ScalewayPublisher(string name, ScalewayPublisherArgs? args = null, ComponentResourceOptions? options = null)
            : base("netskope-publisher:index:ScalewayPublisher", name, args ?? new ScalewayPublisherArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class ScalewayPublisherArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiToken")]
        ...
        public ScalewayPublisherArgs()
        {
        }
        public static new ScalewayPublisherArgs Empty => new ScalewayPublisherArgs();
    }
}
