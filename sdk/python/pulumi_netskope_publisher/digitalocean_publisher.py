...
__all__ = ['DigitaloceanPublisherArgs', 'DigitaloceanPublisher']

@pulumi.input_type
class DigitaloceanPublisherArgs:
    ...
    @ipv6.setter
    def ipv6(self, value: Optional[_builtins.bool]):
    ...
    @vpc_uuid.setter
    def vpc_uuid(self, value: Optional[_builtins.str]):
...
@pulumi.type_token("netskope-publisher:index:DigitaloceanPublisher")
class DigitaloceanPublisher(pulumi.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a DigitaloceanPublisher resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DigitaloceanPublisherArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DigitaloceanPublisherArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is not None:
            ...
            __props__ = DigitaloceanPublisherArgs.__new__(DigitaloceanPublisherArgs)
        ...
        super(DigitaloceanPublisher, __self__).__init__(
